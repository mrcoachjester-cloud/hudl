...
for (let m = functionMatches.length - 1; m >= 0; m--) {
  ...
  // Broadcast every field change to the shared draft. The draft is intentionally
  // separate from `plays`: coaches can see a snap being prepared before it is saved.
