...
function UploadPage({ data, setData }: { data: Dataset; setData: (data: Dataset) => void }) {
  ...
  const handleFile = (file?: File) => {
    if (!file) return;
    if (!effectiveTeam) { toast.notify('Select or enter a Scouting Team before uploading.'); return; }
    setLoading(true);
